...
@rem echo %~dp0\jar_launcher.bat %LAUNCHER% %MIND_OPTS% -Dmindc.launcher.name=mindc %LAUNCHER% --cpp --flatten %*
%~dp0\jar_launcher.bat %LAUNCHER% %MIND_OPTS% -Dmindc.launcher.name=mindc %LAUNCHER% --cpp --flatten %*
