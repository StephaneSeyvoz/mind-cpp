...
@REM 
@REM  Authors: Stephane Seyvoz (Assystem)
@REM  Contributors: 
@REM -----------------------------------------------------------------------------
...
:runMind
%MIND_JAVA_EXE% -classpath %MIND_CLASSPATH% %MIND_OPTS% -Dmindc.launcher.name=mindc %LAUNCHER% --cpp --flatten -src-path=%MIND_RUNTIME% %MIND_CMD_LINE_ARGS%
